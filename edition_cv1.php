...
<html>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a class="bouton_barre" href="contact.php">Contact</a></li>
                    </ul>
                </div><!--/.nav-collapse -->
            </div>
        </nav>
        ...
        <div class="container-fluid contenu">
            <div class="row">
                <form class="col-md-8 col-sm-12 col-xs-12" method="post" name="formulairecv1" action="cv1.php" onsubmit="return valider ();"  enctype="multipart/form-data">
                ...
                <div class="col-md-4 col-sm-12 col-xs-12 trait_screen">
                    <a href="#myModal" data-toggle="modal"><img alt="image template cv 1" class="image_cv1 col-md-12 col-xs-12" src="img/Template_CV1.JPG" /></a>
                </div>
            </div>
        </div>
        ...
        <div id="myModal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <img src="img/Template_CV1.JPG" alt="Screen page inscription" class="col-md-12 screen_fenetre"/>
                </div>
